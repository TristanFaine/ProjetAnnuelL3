...
class Crawler{
    ...
    public function modifier(){ //méthode
        ...
        //écrire la requete d'insertion
        $sql = "UPDATE" . $this->table . "(source, folderchecksum) VALUES('" . $this->source . "','" . $this->folderchecksum ."')";
        // préparation à la requete (objet PDO avec ses méthodes prepare et execute)
        $query = $this->connexion->prepare($sql);
    ...
    public function supprimer(){ //méthode
        ...
        //écrire la requete d'insertion
        $sql = "DELETE FROM" . $this->table . "(source, folderchecksum) WHERE ('" . $this->source . "','" . $this->folderchecksum ."')";
        // préparation à la requete (objet PDO avec ses méthodes prepare et execute)
        $query = $this->connexion->prepare($sql);
